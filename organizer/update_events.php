...
?>
		...
		<!-- MAIN -->
		<main>
			<h1 class="title">Update Events</h1>
			<ul class="breadcrumbs">
				<li><a href="#">Organizer</a></li>
				<li class="divider">/</li>
				<li><a href="#" class="active">Update Events</a></li>
			</ul>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="mb-3">
                                ...
                                <img src="../event_image/<?php echo $current_image;?>" style="width: 30%; margin: 2%;">
                            </div>
                   ...
                   <option value="<?php echo $venue_id; ?>"><?php echo $venue_name;?></option>
                             ...
                             <!-- Event Start Date -->
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" name="eventStartDate" id="eventStartDate" value="<?php echo $event_start?>">
                                </div>

                                    <!-- Event End Date -->
                                    <div class="mb-3">
                                        <label for="eventEndDate" class="form-label">Event End Date</label>
                                        <input type="date" class="form-control" name="eventEndDate" id="eventEndDate" value="<?php echo $event_end?>">
                                    </div>

                                    <!-- Event Title -->
                                    <div class="mb-3">
                                        <label for="eventTitle" class="form-label">Event Title</label>
                                        <input type="text" class="form-control" name="eventTitle" id="eventTitle" placeholder="Enter Event Title" value="<?php echo $event_title?>">
                                    </div>

                                    <!-- Event Description -->
                                    <div class="mb-3">
                                        <label for="eventDescription" class="form-label">Event Description</label>
                                        <textarea class="form-control" name="eventDescription" id="eventDescription" rows="3" placeholder="Enter Event Description"><?php echo $event_desc;?></textarea>
                                    </div>
...
if (isset($_POST['update_events'])) {
 ...
 if (isset($_FILES['eventImage']['name'])) {
   ...
   $check_query = "SELECT * FROM tbl_event WHERE event_venue = '$vid' AND id != '$id' AND (
    (event_start BETWEEN '$eventStartDate' AND '$eventEndDate') OR
    (event_end BETWEEN '$eventStartDate' AND '$eventEndDate')
)";
    ...
    if (is_array($eventAttendees) && !empty($eventAttendees)) {
        ...
        foreach ($eventAttendees as $attendee_id) {
            ...
            SET 
                ...
                event_student = '$student_name',
                student_id = '$attendee_id'
            WHERE id = '$id'"; //
