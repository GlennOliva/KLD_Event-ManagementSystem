                ...
                <div class="row">
                    <div class="col-lg-8">
                        <form style="border: 2px solid #00204a; padding: 20px; border-radius: 12px;">
                            <div class="mb-3">
                                <label for="adminCurrentimage" class="form-label">Current Image</label>
                                <img src="" alt="">
                            </div>
                            <div class="mb-3">
                                <label for="adminFullname" class="form-label">Full Name</label>
                                <input type="text" class="form-control" name="organizerFullname" placeholder="Enter full name">
                            </div>
                            <div class="mb-3">
                                <label for="adminEmail" class="form-label">Email</label>
                                <input type="email" class="form-control" name="organizerEmail" placeholder="Enter email">
                            </div>
                            <div class="mb-3">
                                <label for="adminUsername" class="form-label">Username</label>
                                <input type="text" class="form-control" name="organizerUsername" placeholder="Enter username">
                            </div>
                            <div class="mb-3">
                                <label for="adminPhoneNumber" class="form-label">Phone Number</label>
                                <input type="tel" class="form-control" name="organizerPhoneNumber" placeholder="Enter phone number">
                            </div>
                            <div class="mb-3">
                                <label for="adminPassword" class="form-label">Password</label>
                                <input type="password" class="form-control" name="organizerPassword" placeholder="Password">
                            </div>
                            <div class="mb-3">
