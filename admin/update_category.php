...
?>
                    ...
                    <div class="col-lg-8">
                        <form method="post"  enctype="multipart/form-data" style="border: 2px solid #00204a; padding: 20px; border-radius: 12px;">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="categoryName" placeholder="Enter Event Category Name" value="<?php echo $categoryName;?>">
                            </div>
                            <div class="mb-3">
                                <label for="eventCategory" class="form-label">Category Desc</label>
                                <textarea class="form-control" name="categoryDesc" placeholder="Enter Category Description"><?php echo $categoryDesc?></textarea>
                            </div>
    ...
    if(isset($_POST['update_category']))
    {
        ...
        $sql = "UPDATE tbl_category SET category_name = '$categoryName' , description = '$categoryDesc' WHERE id = '$id'";
        ...
        exit; // Make sure to exit after performing the redirect
            ...
            echo '<script>
                swal({
                    ...
                    window.location = "update_category.php";
                });
            </script>';
