...
?>
		...
		<main>
			...
			<ul class="breadcrumbs">
				...
				<li class="divider">/</li>
				<li><a href="#" class="active">Manage Category</a></li>
			</ul>

            <div class="container mt-3 table-border">
                <a href="add_category.php" class="btn btn-success btn-sm">Create</a>
                ...
                if($result==True)
                {
                    ...
                    if($count>0)
                    {
                        ...
                        <td><?php echo $ids++;?></td>
                            ...
                            <td>
                                <a href="update_category.php?id=<?php echo $id;?>" class="btn btn-primary btn-sm">Update</a>
                                <form action="code.php" method="post">
                                    <button type="button"  class="btn-del delete_categorybtn" value="<?= $id;?>">Delete</button>
                                    </form>
                            </td>
                        </tr>
