...
?>
		...
		<!-- MAIN -->
		<main>
			<h1 class="title">Manage YearLevel</h1>
			<ul class="breadcrumbs">
				<li><a href="#">Admin</a></li>
				<li class="divider">/</li>
				<li><a href="#" class="active">Manage Yearlevel</a></li>
			</ul>

            <div class="container mt-3 table-border">
                <a href="add_yearlevel.php" class="btn btn-success btn-sm">Create</a>
                <table class="table table-hover" id="admin_table">
                    <thead class="thead-dark">
                        <tr>
                            <th>Yearlevel Id</th>
                            <th>Yearlevel Name</th>
                            <th>Action</th>
                        </tr>
                    </thead>
                    <tbody>
                ...
                if($result==True)
                {
                    ...
                    if($count>0)
                    {
                        ...
                        <tr>
                        <td><?php echo $ids++;?></td>
                            <td><?php echo $yearlevelName;?></td>
                            <td>
                                <a href="update_yearlevel.php?id=<?php echo $id;?>" class="btn btn-primary btn-sm">Update</a>
                                <form action="code.php" method="post">
                                    <button type="button"  class="btn-del delete_yearlevelbtn" value="<?= $id;?>">Delete</button>
                                    </form>
                            </td>
                        </tr>
